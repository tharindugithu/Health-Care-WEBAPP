...
export class RegisterComponent implements OnInit {
  ...
  submitreg(r:any){
    ...
    this.service.createUser(r.value).subscribe(()=>{
      ...
      else if(this.errorMessage.valueOf() == "{'uuuUsername': [ErrorDetail(string='Contains some prohibited symbols', code='invalid')], 'Email': [ErrorDetail(string='patient with this Email already exists.', code='unique')]}")
      {
